...
import { CalendarDays, UserPlus, Eye, EyeOff, Sparkles, CheckCircle2 } from 'lucide-react';
      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        ...
        <div className="glass rounded-3xl shadow-2xl border border-white/40 p-8">
          <form onSubmit={(e) => void handleSubmit(e)} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              {password.length > 0 && (
                <div className="flex items-center gap-1.5 text-xs">
                  <div className={`flex-1 h-1 rounded-full ${passwordStrong ? 'bg-emerald-400' : 'bg-amber-400'}`} />
                  <span className={passwordStrong ? 'text-emerald-600' : 'text-amber-600'}>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1">
                  {passwordMatch && <CheckCircle2 className="h-4 w-4 text-emerald-500" />}
                  <button
                    type="button"
            ...
            <Button
              type="submit"
              className="w-full h-11 rounded-xl btn-primary-gradient text-sm mt-2"
              disabled={loading}
            >
              {loading ? (
